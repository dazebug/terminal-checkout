...
(globalThis.TC_I18N = globalThis.TC_I18N || {})['en'] = {
  ...
  "ext.preset.pr.checkout": "Checkout Branch",
  "ext.preset.pr.checkoutClaude": "Checkout + Claude",
  "ext.preset.pr.worktreeClaude": "Worktree + Claude",
  "ext.preset.pr.worktree": "Worktree",
  "ext.preset.pr.review": "Review PR (claude)",
  "ext.preset.issue.read": "Read Issue (claude)",
  "ext.preset.issue.startWork": "Start Work on Issue",
  "ext.preset.issue.open": "Open Issue",
  "ext.preset.repo.open": "Open in Terminal",
  "ext.preset.repo.openClaude": "Open + Claude",
  "ext.preset.repo.updateMain": "Update main",
  "ext.preset.repo.updateMain.face": "main ⤓",
  "ext.button.newButton": "New Button",
  "ext.button.phase.busy": "Opening...",
  "ext.button.phase.done": "Done!",
  "ext.button.phase.error": "Error!",
  "ext.migration.v1.describe": "The command opens with {cd} instead of z {repo}. With no repository base folder set in the Terminal Checkout app this runs exactly what it runs today; if you have set one, z failing now falls back to that folder and clones the repository when it is not there.",
  "ext.migration.v1.prefixDescribe": "Your command continues after the jump. With a base folder set, a failed z now lands in the repository folder underneath it, or in a fresh clone — make sure the rest of this command is safe to run there before accepting it.",
  "ext.migration.v1.customNote": "This command was edited, so it is left exactly as it is — z {repo} is not its first clause, and rewriting it safely would mean parsing the shell. Replace the leading jump with {cd} yourself if you want the same fallbacks.",
  "ext.error.backupFromFuture": "This backup was exported by a newer version of the extension. Update the extension (git pull + refresh at chrome://extensions), or use %1$s to start from the current presets.",
  "ext.error.storedFromFuture": "Your stored settings were written by a newer version of the extension, so this page can show them but must not write over them. Update the extension (git pull + refresh at chrome://extensions).",
  "ext.error.skipConsequence": "Saving will remove them — use %1$s first if you want a copy of what is stored.",
  "ext.error.saveConflict": "Your settings were not saved: they changed on another device while this page was open. Reload to see what is stored — export first if you want to keep your edits.",
  "ext.error.saveReloaded": "This page reloaded its settings while the save was in flight, so the form no longer holds what was about to be written. Check it and press %1$s again.",
  "ext.error.saveLoading": "Settings are being re-read — press %1$s again in a moment.",
  "ext.error.settingsTooLarge": "These settings are too large for Chrome to sync. Shorten the longest command and try again",
  "ext.error.saveBusy": "Already saving — one moment.",
  "ext.error.importStale": "Edits were made while the file was being read — nothing was imported. Import again.",
  "ext.error.importBusy": "A settings file is already being read — try again in a moment.",
  "ext.error.loadFailed": "Could not read your settings. Retry, or reopen this page.",
  "ext.error.skipped": "Unusable entries skipped in %1$s: %2$d",
};
