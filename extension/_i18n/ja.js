// The Japanese dictionary. Item 24 writes the body; it is deliberately empty until then, so
// that a half-translated screen never ships as if it were finished.
//
