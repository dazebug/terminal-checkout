...
// GitHub's stack notice pushes the pair below any fixed line, and a scrolled page puts it above the
// viewport (measured 2026-09-24). The header also renders a hidden (0×0) copy of the pair after the
// visible one.
