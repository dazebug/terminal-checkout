...
- [testing.md](testing.md) — the typed source-audit boundary, the distinction between a source lint and a runtime oracle, and why a gate goes on passing after the thing it describes moves
