...
- [localization.md](localization.md) — where the catalogues live, who owns the language, what the app tells the extension about it, and which strings may never become machine input
