...
- [github-page-reading.md](github-page-reading.md) — why the repository buttons find GitHub's header as the banner landmark rather than by an attribute, why a PR's branch links are picked by document order rather than screen position, and why those selectors reach the worker's injected functions as arguments
