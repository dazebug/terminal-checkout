...
For installation, usage, the variable table, and troubleshooting, see `README.md` at the repository root; for the hands-on checklist when adding a terminal, see `docs/new-terminal-checklist.md`.
